<?php
    ...
    $letra=$_GET['letra'];
	$lleg=$_GET['lleg'];
    $guardar=fopen('AP_relleno2.txt','a+');
    fwrite($guardar,$ini);
    fwrite($guardar,",");
	fwrite($guardar,$lleg);
	fwrite($guardar,"\n");
		...
		<div class="container">
			...
			<div class="row animate-box">	
				<div class="col-md-6 col-md-offset-3 text-center heading-section">
					...
					<form action="ap_final1" mclass="#fh5co-started" method="GET">
						<p align = "text-center">	
							<p align = "text-center">
							Punto inicial <input type="number" min="0" name="ini">
							<br>
							<br>
							Transicion <input type="char" name="letra">
							<br>
							<br>
				...
				<div>
                <a href="ap_resultados"><input type="button" value="Resultados"></a>
            </div>
		</div>
	</div>
